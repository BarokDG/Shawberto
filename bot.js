...
var bot = new grammy_1.Bot("5898666265:AAHCrh13937amAcJiq_B8qRpCi_TBMZesNo");
bot.hears(/^https:\/\/www.tiktok.com\/.*/g, function (ctx) {
    var _a;
    if (!((_a = ctx.message) === null || _a === void 0 ? void 0 : _a.text))
        return;
    try {
        fetchVideo(ctx.message.text).then(function (videoUrl) {
            if (!videoUrl) {
